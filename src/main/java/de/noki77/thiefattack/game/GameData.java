...
public class GameData {
    private transient File gameWorldContainer;
    ...
    public GameData(String gameName, int gameId) {
        ...
        this.gameId = gameId;
        this.gameWorldContainer = new File(ThiefAttack.getInstance().getPluginConfig().getGameMapDirectory(), gameName);
    }
    ...
    public File getGameWorldContainer() {
        return this.gameWorldContainer;
    }
